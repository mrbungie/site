...
<TaxonomyBox
  modelType="Una función lineal seguida de una sigmoide para producir probabilidades de clase en clasificación binaria."
  optimizationMethods={[
    "Descenso por gradiente, mini-batch o SGD",
    "Métodos de segundo orden como Newton-Raphson o IRLS",
    "Optimizadores cuasi-Newton como LBFGS o variantes regularizadas tipo saga/liblinear",
  ]}
  typicalOptimization="Máxima verosimilitud con gradiente o LBFGS"
  typicalLoss="Log loss o entropía cruzada binaria"
/>
